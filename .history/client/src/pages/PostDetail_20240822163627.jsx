...
import Thumbnail from '..//hoi-nghi-trien-khai-thong-tu-242024tt-btc-va-pho-bien-phap-lenh-xu-phat-trong-linh-vuc-kiem-toan.jpg'
...
const PostDetail = (postID, category, title, desc, authorID, thumbnail) => {
    ...
    return (
        ...
        <div className='post-detail'>
            ...
            {posts.map((post) => (
                    <div className=" post-detail__container" key={post.id}>
                        <div className="img" >
                            <img src={post.thumbnail} alt="" />                     
                        </div>
                        <div className="content_pdetail">
