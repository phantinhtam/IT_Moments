...
import LikeImg from '../images/avt_cv.jpg'
                ...
                <div className='post'>
                    ...
                    <div className='likSection'>
                        <div className='imagesLike'>
                            ...
                            <img className='likeImg2' src={LikeImg} alt=''/>
                            <img className='likeImg3' src={LikeImg} alt=''/>
                        </div>
                        <div className='noOfLikes'>111,111 Likes</div>
                    </div>
                </div>
            </div>
        </div>
